...
var Database = /** @class */ (function () {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.db = new sqlite3_1.default.Database(_this.dbPath, function (err) {
                            if (err) {
                                ...
                                console.log("Connected to SQLite database at ".concat(_this.dbPath));
                                resolve();
                            }
                        });
                    })];
    ...
    Database.prototype.run = function (sql_1) {
    ...
    Database.prototype.get = function (sql_1) {
        return __awaiter(this, arguments, void 0, function (sql, params) {
            var _this = this;
            if (params === void 0) { params = []; }
            return __generator(this, function (_a) {
    ...
    Database.prototype.all = function (sql_1) {
        return __awaiter(this, arguments, void 0, function (sql, params) {
            var _this = this;
            if (params === void 0) { params = []; }
            return __generator(this, function (_a) {
