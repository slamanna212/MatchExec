...
function initializeDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var db, migrationRunner, seeder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = (0, connection_1.getDatabase)();
                    // Connect to database
                    return [4 /*yield*/, db.connect()];
                case 1:
                    // Connect to database
                    _a.sent();
                    migrationRunner = new migrations_1.MigrationRunner(db);
                    return [4 /*yield*/, migrationRunner.runMigrations()];
                case 2:
                    _a.sent();
                    seeder = new seeder_1.DatabaseSeeder(db);
                    return [4 /*yield*/, seeder.seedDatabase()];
                case 3:
                    _a.sent();
                    return [2 /*return*/, db];
            }
