-- Remove unused Discord settings fields (command_prefix and auto_role_assignment)
-- SQLite doesn't support DROP COLUMN, so we need to recreate the table

-- Create new table without the legacy fields and add application_id
...
INSERT INTO discord_settings_new (
  ...
  results_channel_id, moderator_role_id, participant_role_id, 
  created_at, updated_at
)
SELECT 
  id, NULL as application_id, bot_token, guild_id, announcement_channel_id,
  results_channel_id, moderator_role_id, participant_role_id,
  created_at, updated_at
